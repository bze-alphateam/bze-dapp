...
export function getChartIntervalsLimit(chart: string) {
    switch (chart) {
        case CHART_4H: return (12 * 24) * 7; // 1 week
        case CHART_1D: return (4 * 24) * 30; // 2 weeks
        case CHART_7D: return 24 * 90; // 3 months
        case CHART_30D: return 6 * 365; //  1 year
        case CHART_1Y: return 365 * 3; // 3 years
        default: return 12;
    }
}
...
export function getChartMinutes(chart: string) {
  switch (chart) {
    case CHART_4H: return 5;
    case CHART_1D: return 15;
    case CHART_7D: return 60;
    case CHART_30D: return 240;
    case CHART_1Y: return 1440;
    default: return 5;
  }
}
