...
class Listener {
    ...
    start(): void {
        ...
        TmWebSocket.subscribe(SUB_ID_RAFFLE_LOST, raffleLostEventQuery(), (e: any) => {
            this.onRaffleLost(e)
        });
        TmWebSocket.subscribe(SUB_ID_RAFFLE_WINNER, raffleWinEventQuery(), (e: any) => {
            this.onRaffleWinner(e)
        });
